...
;Name und Name der Datei
	...
	Name "Neo2.0 - TEST DUMMY"
	OutFile "Neo2.0_DUMMY.exe"
...
;Die eigentlichen Sections
	...
	SectionIn 3
		SetOutPath "$INSTDIR"
		; file neo-vars\out\neo20.exe
		; createShortCut "$SMPROGRAMS\Autostart\Neo2.0 (AHK)"  "$INSTDIR\neo20.exe"
...
;Datei beim User schreiben, obwohl als Admin eingeloggt
	Function goUserDir
		createShortCut "$SMPROGRAMS\Autostart\AHK für kbdneo.lnk"  "$INSTDIR\kbdneo_ahk.exe"
	FunctionEnd
...
VIAddVersionKey /LANG=${LANG_GERMAN} "FileDescription" "Neo 2.0 InstallationsDUMMY"

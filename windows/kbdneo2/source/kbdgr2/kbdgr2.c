...
{VK_NUMPAD7		,0			,'7'		,'7'			,updownarrow			,checkmark		},
{VK_NUMPAD8		,0			,'8'		,'8'			,uparrow				,ballotcross		},
...
DEADTRANS(	Multi_key	,	checkmark	,	checkmark	,	0x0001),
DEADTRANS(	Multi_key	,	ballotcross	,	ballotcross	,	0x0001),
...
DEADTRANS(	checkmark	,	0x25A1	,	0x2611	,	0x0000),
DEADTRANS(	ballotcross	,	0x25A1	,	0x2612	,	0x0000),
...
DEADTRANS(	0x25A1	,	checkmark	,	0x2611	,	0x0000),
DEADTRANS(	0x25A1	,	ballotcross	,	0x2612	,	0x0000),
